...
const Header = () => {
  ...
  return (
    <div
      className={`fixed top-0  left-0 w-full z-50  border-b border-n-6 lg:bg-table-gradient lg:backdrop-blur-sm ${
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4 ">
        ...
        <a
          href="#signup"
          className="button hidden mr-8 text-n-1/70 transition-colors hover:text-n-1 lg:block"
        >
          New Account
        </a>
